...
class RF_General {
   ...
   /**
    * Hide core update notice for all users but Admins
    *
    * @since 1.1.0
    */
   ...
   /**
    * Remove unused menu items by adding them to the array. to do take commented out menu item into argument like so: $restricted = array('Media');
    *
    * @since 1.0.0
    */
   ...
   /**
    * Change post update messages to be post type-specific, shows product updated msg if you move your products 
    *
    * @since 1.0.0
    */
